...
pub fn handle(
    ...
    let grantor_settle_per_deposited =
        dcd_arguments.ratio_args.total_asset_amount / dcd_arguments.ratio_args.grantor_settlement_token_amount;
    let amount_to_get = grantor_settlement_amount_to_burn.saturating_mul(grantor_settle_per_deposited);
