...
pub fn handle(
    ...
    let grantor_coll_per_deposited =
        dcd_arguments.ratio_args.interest_collateral_amount / dcd_arguments.ratio_args.grantor_collateral_token_amount;
    let amount_to_get = grantor_collateral_amount_to_burn.saturating_mul(grantor_coll_per_deposited);
