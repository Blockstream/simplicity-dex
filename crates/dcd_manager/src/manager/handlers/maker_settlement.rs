...
pub fn handle(
    ...
    anyhow::ensure!(
        grantor_amount_to_burn <= available_grantor_coll && grantor_amount_to_burn <= available_grantor_settle,
    ...
    if price <= dcd_arguments.strike_price {
        ...
        let utxos = vec![asset_txout, grantor_coll_txout, grantor_settle_txout, fee_txout];
        ...
        let per_settlement_collateral =
            dcd_arguments.ratio_args.total_collateral_amount / dcd_arguments.ratio_args.grantor_collateral_token_amount;
