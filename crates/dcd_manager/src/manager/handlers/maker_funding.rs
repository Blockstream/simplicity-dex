use crate::manager::common::{
    AssetEntropyProcessed, derive_public_blinder_key, obtain_utxo_value, raw_asset_entropy_bytes_to_midstate,
};
...
pub fn handle(
    ...
    let filler_reissue_token_id = AssetId::reissuance_token_from_entropy(filler_token_asset_entropy, false);
...

    {
        ...
        filler_reissuance_tx.issuance_value_amount = Some(dcd_arguments.ratio_args.filler_token_amount);
        filler_reissuance_tx.issuance_inflation_keys = None;
        filler_reissuance_tx.issuance_asset_entropy = Some(filler_token_asset_entropy.to_byte_array());
    ...
    }
    {
        ...
        grantor_collateral_reissuance_tx.witness_utxo = Some(grantor_collateral_token_utxo_tx_out.clone());
    ...
    }
    {
        ...
        grantor_settlement_reissuance_tx.witness_utxo = Some(grantor_settlement_token_utxo_tx_out.clone());
    ...
    // Fee
    pst.add_output(Output::new_explicit(Script::new(), fee_amount, change_asset, None));
