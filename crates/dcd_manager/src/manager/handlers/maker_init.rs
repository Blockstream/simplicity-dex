...
use simplicityhl_core::{
    LIQUID_TESTNET_BITCOIN_ASSET, finalize_p2pk_transaction, get_new_asset_entropy, get_p2pk_address,
};
use simplicityhl_core::{TaprootPubkeyGen, fetch_utxo, get_random_seed};
...
pub fn handle(
    ...
    Ok((tx, entropies_to_return, dcd_taproot_pubkey_gen))
}
