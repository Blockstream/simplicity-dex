...
pub fn handle(
    ...
    pst.global.tx_data.fallback_locktime = Some(LockTime::from_height(dcd_arguments.settlement_height)?);
    ...
    if price <= dcd_arguments.strike_price {
        ...
        let per_settlement_collateral =
            dcd_arguments.ratio_args.total_collateral_amount / dcd_arguments.ratio_args.filler_token_amount;
        ...
        let per_settlement_asset =
            dcd_arguments.ratio_args.total_asset_amount / dcd_arguments.ratio_args.filler_token_amount;
